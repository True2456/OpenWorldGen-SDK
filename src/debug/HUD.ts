...
export class Hud {
  ...
  private render(): void {
    ...
    const lines: string[] = [
      `OpenWorldSDK  seed=${this.params.seed} scene=${this.params.scene} T=${this.params.timeOfDay}`,
    ...
    lines.push('—', 'F3 hud · V walk/fly · 1-9 bookmarks · F flythrough · P pose · ,/. season');
